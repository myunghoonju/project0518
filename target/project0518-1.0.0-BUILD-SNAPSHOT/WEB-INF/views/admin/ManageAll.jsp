...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="../../index3.html" class="brand-link">
      <img src="../../resources/dist/img/AdminLTELogo.png"
           ...
           style="opacity: .8">
      <span class="brand-text font-weight-light">정보관리</span>
    </a>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="/">처음으로</a></li>
              <li class="breadcrumb-item active">정보관리화면</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-12">
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">등록상품정보관리</h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020 <a href="/">주명훈</a>.</strong> All rights
    reserved.
  </footer>
